    ...
    <div className="police-brutality">
      <div className="collection-list-wrapper w-dyn-list">
        <div className="collection-list w-dyn-items">
          {library?.slice(0, 50).map((clip, i) => {
            return (
              clip.Video['Image Filename'].match(/\.mp4/) && (
                <div
                  key={i}
                  role="listitem"
                ...
                >
                  ...
                  >
                    <h2 className="item-number">{clip['TGD Number']}</h2>
                    <div
                      ...
                      <div className="content-wrapper">
                        <div className="double-title-wrapper">
                          <div className="title-wrapper">
                            <h2 className="state">{clip.State}</h2>
                            <h2 className="city">—</h2>
                            <h2 className="city">{clip.City}</h2>
                          </div>
                        </div>

                        <p className="description">
                          {clip['Doucette Text'].slice(0, 100)}
                          {clip['Doucette Text'].length > 100 ? '...' : ''}
                        </p>
                      </div>
                      ...
                      /> */}
                        ...
                        <video controls>
                          <source
                            ...
                            src={`https://s3.wasabisys.com/police-brutality/doucette-thread/${clip.Video['Image Filename']}`}
                          />
                        </video>
                      </div>
